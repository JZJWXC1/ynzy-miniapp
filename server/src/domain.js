...
const NEG_AFTER_CORE = '不(?!错|赖|差|止|仅)|没(?!问题|得说|的说|话说)|无|未|非|禁|谢绝|婉拒|停做|停止|取消|限制|暂停'
const NEG_BEFORE_CORE = '不(?!错|赖|差|止|仅|了)|没(?!问题|得说|的说|话说)|无|未|非|禁|缺|谢绝|婉拒|停做|停止|取消|限制|暂停'
...
// 特征词【前】：本子句内、词前一小段以否定收尾（无燃气 / 不能用燃气 / 不接短租 / 不可短租 …）
const NEGATION_BEFORE = new RegExp(`(?:${NEG_BEFORE_CORE}).{0,2}$`)
