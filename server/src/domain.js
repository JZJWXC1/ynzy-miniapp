...
const NEG_AFTER_CORE = '不(?!错|赖|差|止|仅)|没(?!问题|得说|的说|话说)|无|未|非|禁|拒|谢绝|婉拒|停做|停止|取消|限制|暂停'
const NEG_BEFORE_CORE = '不(?!错|赖|差|止|仅|了)|没(?!问题|得说|的说|话说)|无|未|非|禁|缺|拒|谢绝|婉拒|停做|停止|取消|限制|暂停'
